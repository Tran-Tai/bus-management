...
<div class="container col-6 my-1 p-1">
    <form class="was-validated" method="POST">
        ...
        <!-- <div class="form-group">
            ...
            <input type="number" name="total_time_hour" min="0" max="23" value="00" required>
            :
            <input type="number" name="total_time_minute" min="0" max="59" value="00" required>
            :
            <input type="number" name="total_time_second" min="0" max="59" value="00" required>
        </div> -->
